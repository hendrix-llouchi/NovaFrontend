...
const LoginPage = () => {
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex w-[45%] bg-slate-950 relative overflow-hidden flex-col justify-between p-12">
        {/* Glow effect */}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:px-24">
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex items-center gap-1 p-1 bg-slate-50 border border-slate-100 rounded-2xl mb-10">
            ...
            <button className="flex-1 py-2.5 rounded-xl text-slate-500 hover:text-slate-900 font-bold text-sm transition-colors">
              Sign Up
            </button>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            Don't have an account? <a href="#" className="font-bold text-slate-950 hover:underline">Sign up</a>
          </p>
